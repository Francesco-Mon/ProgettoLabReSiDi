...
if __name__ == '__main__':
    # Avvia il login automatico all'avvio del client
    automatic_login()

    # Se il login è riuscito, avvia le richieste automatiche in un thread separato
    if logged_in:
        threading.Thread(target=automatic_requests, daemon=True).start()
